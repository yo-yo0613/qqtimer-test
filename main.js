...
const algorithm = [
    "[R' B' R : [R D R' , U']]","[R' D R U2 : [R' D' R , U]]","[F : [U2 , F' R F R']]","[R' D R , U2]","[U' : [R D' R' , U2]]","[r D' U : [R D R' , U2]]","[D U' : [R D R' , U2]]","[D : [R' D' R , U2]]","[R' U D R2 : [U' , R' D' R]]","[U' : [R D R' , U2]]","[R' D' R , U2]","[R' U D : [R D R' , U2]]","[D' U' : [R D R' , U2]]","[D U' : [R D' R' , U2]]","[R F' R' U' : [R D R' , U2]]","[R' D R U' R D' R' , U2]","[R D' R' : [R' D R , U2]]","[R' U' D' R : [R U' R' , D]]",
    "[R' B' R : [U' , R D R']]","[R F' R' : [R' D R, U]]","[R : [U , R D R']]","[R2 : [D' , R U' R']]","[R' D R , U]","[U' , R D' R']","[R2 U' : [D' , R U R']]","[D' : [R' D R , U]]","[D : [R' D' R , U]]","[U' , R D R']","[R' D' R , U]","[R2 U : [R' U' R , D]]","[D' : [U' , R D R']]","[D : [U' , R D' R']]","[R F' : [R' U' R , D]]","[R' D R U' R D' R' , U]","[U' , R D' R' U R' D R]","[R' B : [D' , R U R']]",
    "[R' D R U' : [R' D' R , U']]","[R F' R' : [U , R' D R]]","[U' R2 : [D , R' U2 R]]","[R' D R , U']","[U' : [R D' R' , U']]","[D' : [R' D R , U']]","[D : [R' D' R , U']]","[U' R' : [U2 , R' D' R]]","[U' : [R D R' , U']]","[R' D' R , U']","[R' D' : [U' , R' D R]]","[U' R' : [U' , R' D' R]]","[D : [R' D R , U']]","[D' : [R' D' R , U']]","[R' U' R : [F2' , R' U R U']]","[R' D R U' R D' R' , U']","[R D' R' : [R' D R , U']]","[R' D' R : [R U' R' , D]]",
    ...
    "[R' U' D' R : [D , R U' R']]","[R' B : [R U R' , D']]","[R' D' R : [D , R U' R']]","[R : [U , R D' R']]","[U' D R' U : [D , R U' R']]","[D R : [F2 , R' U R U']]","[R2 U : [R' U R , D']]","[R' D' R : [D ,R U R']]","[D R D : [R' D' R , U]]","[D U' R' : [U2 , R' D R]]","[U D' R D' : [R' D R , U']]","[R2 : [R' U' R , D']]","[R U' : [D' , R' U R]]","[R2 U : [R' U' R , D']]","[R U' D' : [R' U R , D2]]","[R U' D' : [R' U R , D']]","[R U' R' U' : [R D' R' , U2]]","[R U' R' : [D' , R' U R]]"
];
