...
const algorithm = [
    ...
    "Ab perm","U' Ab perm","[R : [U , R D R']]","[R2 : [D' , R U' R']]","[R' D R , U]","[U' , R D' R']","[R2 U' : [D' , R U R']]","[D' : [R' D R , U]]","[D : [R' D' R , U]]","[U' , R D R']","[R' D' R , U]","[R2 U : [R' U' R , D]]","[D' : [U' , R D R']]","[D : [U' , R D' R']]","[R F' : [R' U' R , D]]","[R' D R U' R D' R' , U]","[U' , R D' R' U R' D R]","[R' B : [D' , R U R']]",
